  ...
  mainPane: SC.MainPane.design({
	...
	detailCommentPane: SC.PanelPane.create({
		...
		showForUpdate: function() {
		      ...
		      // CinnamonDolceLatte.commentController.updateCurrent();
		},
		
		save: function() {
	        CinnamonDolceLatte.commentController.save();
			this.set('detailIsVisible', NO);
			// CinnamonDolceLatte.mainPage.mainPane.middleView.bottomRightView.bottomRightView.commentContentView.reload();
			// CinnamonDolceLatte.mainPage.mainPane.middleView.render();
	    },
